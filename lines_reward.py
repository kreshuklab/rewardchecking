        ...
        for single_pred, single_sp_seg, s_dir_edges in zip(prediction_segmentation, superpixel_segmentation, dir_edges):
            ...
            for fg_pred_id in fg_pred_ids:
                ...
                if any(accepted_lines):
                    ...
                    line_sps = [torch.unique(single_sp_seg[line_idx[1], line_idx[0]]).long() for line_idx in line_idxs]
                    obj_ids = [torch.unique(single_pred[line_idx[1], line_idx[0]]) for line_idx in line_idxs]
